...
function Footer() {
  ...
  return (
    <footer className="bg-[#141414] text-white max-w-full sm:min-w-full px-4 md:px-8">
      <div className="w-full max-w-lg md:max-w-3xl lg:max-w-4xl x12:max-w-7xl mx-auto">

          {/* Main Flex Section */}
          <div className="flex flex-col md:flex-row-reverse justify-between gap-10 md:gap-16 mb-6">
            
            {/* Company & Support */}
            <div className="flex md:w-[85%] flex-row justify-between">
            ...
            <div className="md:w-[70%]">
              <h3 className="text-lg font-semibold mb-3">Watch & Earn</h3>
                ...
                {/* Buttons */}
                <div className="flex max-w-[80%] gap-4 items-center mt-6">
          ...
          <div className="flex flex-col mb-10 md:flex-row justify-between items-start gap-2 text-gray-500 text-sm">
            ...
            <p>© {new Date().getFullYear()} BoyAlone. All rights reserved.</p>
          </div>
      </div>
  </footer>
